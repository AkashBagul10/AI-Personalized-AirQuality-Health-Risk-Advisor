...
class DecisionTreeTrainer:
    ...
    def train_decision_tree(self, dataset_path=None):
        ...
        print("⏳ Training started (should be very fast)...")
    ...
    def evaluate_model(self, X_train_scaled, X_test_scaled, y_train, y_test, feature_names):
        ...
        if test_r2 > current_best_r2:
            print(f"🎉 DECISION TREE OUTPERFORMS Neural Network!")
        elif test_r2 > 0.95:
            print(f"📊 DECISION TREE is COMPETITIVE with top models!")
        elif test_r2 > 0.9:
            print(f"👍 DECISION TREE shows GOOD performance!")
        else:
            print(f"📉 DECISION TREE performance needs improvement.")
...
if __name__ == "__main__":
    print("🚀 Training Decision Tree")
    print("🌳 Simple but interpretable model")
    print("📊 Testing if a single tree can compete with ensembles")
    ...
    if model:
        ...
        print("📁 Run: python universal_model_tester.py for full comparison")